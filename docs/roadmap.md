...
- [ ] Add a coverage gate to CI with slow ratchet — start at the current `--fail-under-lines 66` baseline, raise after the cold-spot work lands. Ship a custom per-module report alongside; global coverage hides `main.rs`-class gaps.
